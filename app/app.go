...
func ImageFetchHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		util.ErrorLog("app", "记录访问流量与频次失败，原因：" + err.Error(), "app->ImageFetchHandler")
	}
...
func ImageUploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	// 写入图像
	err, fileSizeByte := WriteImage(guid, imageFileStream.Bytes(), storageFileType, compressLevel, maxWidth)
	if err != nil {
